#!/usr/bin/env bash
# Uninstalls translate: stops + removes its containers and any named
# volumes, deletes its data directory (wherever DATA_DIR points - see
# install.sh) and backups/translate/, and removes its .env and
...
#   ./uninstall.sh --keep-backups # keep backups/translate/
