#!/usr/bin/env bash
# Uninstalls llm-assistant: stops + removes its containers and any named
# volumes, deletes its data directory (wherever DATA_DIR points - see
# install.sh) and backups/llm-assistant/, and removes its .env and
...
#   ./uninstall.sh --keep-backups # keep backups/llm-assistant/
